  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-6 py-16 text-center bg-gradient-to-b from-[#720110] to-black">
      ...
      <p className="text-lg leading-relaxed max-w-3xl mb-6 text-white">
        A fan-made tool to help Hitman players identify Freelancer targets. Filter
      ...
      <div className="w-full max-w-3xl mb-12">
        <div className="flex items-center gap-3">
          ...
          >
            {([
              "Finder screen showing attribute filters (Earrings, Glasses, Hat, Necklace, Tattoo) and hair color selector, with 12 of 72 bald leaders displayed including Yvonne and Hugo",
              "Finder screen with Earrings, Glasses, and Hat filters active, narrowing results to 2 of 72 leaders — Angel and Gonzales, both bald",
              "Leader detail view for Gonzales showing his full illustration, bald hair label, and accessory icons for Earrings, Glasses, Hat, Necklace, and Tattoo",
              "Items screen listing all Hitman Freelancer locations — Ambrose Island, Bangkok, Berlin, Chongqing, Colorado, Dartmoor, Dubai, Haven Island, Hokkaido, and Isle of S'gail — with weapon counts",
              "Items detail view for Ambrose Island listing 8 weapons including Shotgun 12G Short H, Handgun 75R, SMG X2, SMG X2 Covert (carried by Noel Crest), Folding Knife, Assault Rifle G1-4/C, Oil Canister, and Assault Rifle A33",
            ] as const).map((alt, i) => (
              <div
                key={i}
