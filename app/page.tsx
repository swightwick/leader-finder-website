  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-6 py-16 text-center bg-gradient-to-b from-[#720110] to-black">
      ...
      <p className="text-base leading-relaxed max-w-2xl mb-12 text-secondary">
        ...
        and narrow down suspects in seconds. Available now on iOS.
      </p>
      ...
      <div className="w-full max-w-3xl mb-12">
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex-shrink-0 w-10 h-10 flex items-center justify-center rounded-full border border-white/20 text-white text-xl hover:bg-white/10 transition-colors"
          >
            ‹
          </button>
      ...
      <a
        href="#"
        className="inline-flex flex-col items-center gap-4 opacity-90 hover:opacity-100 transition-opacity duration-200 border border-white/20 rounded transition-all duration-200 hover:bg-white/10 px-10 py-3"
      >
